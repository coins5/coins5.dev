...
author: "coins5"
image:
  url: "/src/assets/images/series/loguru/structured_logging_with_loguru.png"
  alt: "Structured Logging with Loguru: JSON for Observability Tools."
tags: ["python", "logging", "loguru"]
nextPost: "series/loguru/loguru-handle-concurrency"
serie: "learn-loguru"
seriesPartNumber: 3
---
